...
psychobabble = [
    ...
    [r'(?:как дела у тебя|как дела|как у тебя дела)\?',
     ["нормально,как ты себя чувствуешь сегодня?",
    ...
    [r'.*(?:Я нуждаюсь|нуждаюсь) (.*)',
     [
         "Ты уверен, что ты нуждаешься {0} ?"]],

    [r'.*(?:Почему ты не можешь|не можешь|ты не можешь) (.*)\?',
    ...
    [r'Я имею (.*)',
     ["Почему ты говоришь мне, что ты имеешь {0} ?",
      "ты правда имеешь {0} ?",
...
def analyze(statement):
    for pattern, responses in psychobabble:
        ...
        match = regular_expression.match(statement.rstrip(".!"))
